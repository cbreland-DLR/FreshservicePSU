...
Read the [target architecture](../docs/ARCHITECTURE.md),
...
shared transport, authentication, connection, or output behavior. Use the
[modernization overview](../docs/ARCHITECTURE_MODERNIZATION_PLAN.md) to resolve
