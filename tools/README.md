...
`Get-PsuIdentityEvidence.ps1` collects the facts that open questions Q1, Q2, and
Q3 need from a live PowerShell Universal instance. Those questions block
declaring the identity adapter deployment-ready and the Phase 8 release matrix.
...
- **It is read-only.** The report file is the only thing it writes.
